...
numChannels=19;
condition='bird'; %threat, sound or bird
...
for i=1:length(channels)
    for j=1:length(bands) 
        ...
        figure; boxplot([all_subj_feats(:,1,find(columnNames==label)), all_subj_feats(:,2,find(columnNames==label)), all_subj_feats(:,3,find(columnNames==label)), all_subj_feats(:,4,find(columnNames==label))])
